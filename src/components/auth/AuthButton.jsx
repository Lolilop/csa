      ...
      {isAuthenticated ? (
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className={`flex items-center space-x-2 rounded-full pr-3 transition-all duration-300 ${isScrolled || isMobile ? 'hover:bg-blue-700' : 'hover:bg-white/20'}`}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${buttonStyles} hover:shadow-md`}
          >
