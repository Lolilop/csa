        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#sections" className="text-blue-200 hover:text-white transition-colors">Nos Sections</a></li>
              <li><a href="#about" className="text-blue-200 hover:text-white transition-colors">À Propos</a></li>
              <li><a href="#events" className="text-blue-200 hover:text-white transition-colors">Événements</a></li>
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Tarifs & Inscriptions</a></li>
