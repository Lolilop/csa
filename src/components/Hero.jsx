    ...
    <div id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-center py-16">
        <div className="max-w-4xl mx-auto">
          {/* Category indicator */}
          <div 
            className="inline-block mb-6 transition-all duration-1000 transform translate-y-0 opacity-100"
            style={{ 
              transitionDelay: '200ms',
              animation: 'fadeInUp 0.6s ease-out'
            }}
          >
            <span className="px-4 py-1 rounded-full text-sm font-semibold tracking-wider uppercase bg-white/20 text-white backdrop-blur-sm border border-white/20">
              {currentBackground.category}
            </span>
          </div>
